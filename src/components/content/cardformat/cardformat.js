...
class CardFormat extends React.Component {

    render() {
        return (
            <div className="row dspcard">
            ...
            <div className="col-lg-5 remove-padding table-responsive">
...
export default translate(CardFormat)
